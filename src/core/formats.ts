...
const formats: FormatDefinition[] = [
  ...
  { id: 'ldraw', label: 'LDraw', extensions: ['ldr', 'mpd', 'dat'], family: 'scene', packageSupport: true, animations: false, materials: true, repair: false, loader: 'extra', description: 'LEGO-compatible LDraw models and multi-part documents.' },
